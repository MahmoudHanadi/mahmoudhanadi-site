...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl p-8 md:p-14 text-center bg-gradient-to-r from-olive/30 via-teal/30 to-keffiyeh-red/30 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 shadow-sm">
      {/* Animated blurred blobs in the background */}
      {!prefersReducedMotion && (
        <>
          <motion.div
            aria-hidden
            className="absolute -top-10 -left-10 w-64 h-64 bg-olive/30 rounded-full blur-3xl"
          ...
          <motion.div
            aria-hidden
            className="absolute bottom-0 -right-16 w-72 h-72 bg-keffiyeh-red/30 rounded-full blur-3xl"
            initial={{ opacity: 0, scale: 0.8 }}
      ...
      <Mascot />
      <motion.h1
        className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-gray-900 via-olive to-keffiyeh-red dark:from-gray-100 dark:via-olive dark:to-keffiyeh-red bg-clip-text text-transparent"
      ...
      <p className="text-lg md:text-xl mb-6 text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
        Leadership, strategy, and hands‑on execution across BD, Google Ads, product and ops. Get results that matter.
      </p>
